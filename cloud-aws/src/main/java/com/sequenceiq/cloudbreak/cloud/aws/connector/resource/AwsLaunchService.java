...
public class AwsLaunchService {
    ...
    private void updateCloudformationWithLoadBalancers(AuthenticatedContext ac, CloudStack stack, PersistenceNotifier resourceNotifier,
        ...
        if (!cloudLoadBalancers.isEmpty()) {
            ...
            for (CloudLoadBalancer cloudLoadBalancer : cloudLoadBalancers) {
                convertLoadBalancer(cloudLoadBalancer, instances, awsNetworkView, amazonEC2Client, awsLoadBalancers);
            }
    ...
    private void convertLoadBalancer(CloudLoadBalancer cloudLoadBalancer, List<CloudResource> instances,
        ...
        if (existingLoadBalancer.isPresent()) {
            ...
            awsLoadBalancers.add(currentLoadBalancer);
        }
    ...
    private Set<String> selectLoadBalancerSubnetIds(LoadBalancerType type, AwsNetworkView awsNetworkView) {
        ...
        if (type == LoadBalancerType.DEFAULT_GATEWAY) {
